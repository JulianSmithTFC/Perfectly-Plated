...
if($qb_customer_id > 0 && $MSQS_QL->get_option('mw_wc_qbo_sync_order_qbo_sync_as') == 'Invoice' && !$MSQS_QL->is_plg_lc_p_l() && $MSQS_QL->option_checked('mw_wc_qbo_sync_wam_mng_inv_ed')){
	...
	<div class="invoice_container">
	  ...
	  <table class="invoice_table">
		...
		?>
	      <tr>
	        ...
	        <td>
				<a href="<?php echo $pdf_url.$qbo_id;?>"<button type="button" class="btn btn-pdf">PDF</button></a>
	 ...
	 <?php else:?>	  
	  <div class="alert alert-warning">
		<strong>No</strong> Invoices Found.
	  </div>
