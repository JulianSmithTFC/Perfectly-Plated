							...
							<tr class="advanced_payment_sync">
                                ...
                                <td>
									...
									<tr class="advanced_payment_sync">
										...
										<?php foreach($wc_currency_list as $c_val){?>			
										<td>
											<input data-cba="<?php echo $pm_key;?>__<?php echo $c_val;?>_udfacc" data-cba-vendor="<?php echo $pm_key;?>__<?php echo $c_val;?>_vendor" data-cba-lwb="<?php echo $pm_key;?>__<?php echo $c_val;?>_lwb" data-cba-ibs="<?php echo $pm_key;?>__<?php echo $c_val;?>_ibs" class="pm_chk_batch pm_chk" type="checkbox" value="1" name="<?php echo $pm_key;?>__<?php echo $c_val;?>_ebatch" id="<?php echo $pm_key;?>__<?php echo $c_val;?>_ebatch">
										</td>
										<?php }?>
										<td>
										<div class="material-icons tooltipped right tooltip"><?php echo __('?','mw_wc_qbo_sync') ?>
