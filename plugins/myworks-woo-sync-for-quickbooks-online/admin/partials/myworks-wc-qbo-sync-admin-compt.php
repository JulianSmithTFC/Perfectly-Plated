...
<div class="container map-coupon-code-outer">
	...
	<?php wp_nonce_field( 'myworks_wc_qbo_sync_save_compt_stng', 'map_wc_qbo_update_compt_stng' ); ?>
		...
		$seq_p_name = '';
		$seq_p_file = '';
		if($MSQS_QL->is_plugin_active('woocommerce-sequential-order-numbers-pro','woocommerce-sequential-order-numbers',true)){
		...
		<!--WooCommerce AvaTax-->
		<?php if(!$disable_section && $MSQS_QL->is_plugin_active('woocommerce-avatax')):?>
		<?php $is_compt=true;?>
		<div class="page_title">
