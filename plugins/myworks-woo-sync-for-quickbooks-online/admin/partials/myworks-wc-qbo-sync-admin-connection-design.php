					...
					<div class="quick-book">
					   <div class="quick-pdng">
						  ...
						  <div class="Connect-now">
							 <a  target="_blank" href="https://myworks.software/account/clientarea.php?action=productdetails&id=<?php echo (int) $MSQS_QL->get_option('mw_wc_qbo_sync_service_id');?>" class="CmnBtn">Manage Connection</a>
						  </div>
					   </div>
					</div>
				 ...
				 <?php else:?>
					<div class="quick-book">
					   <div class="quick-pdng">
						  ...
						  <div class="Connect-now">
							 <a  target="_blank" href="https://myworks.software/account/clientarea.php?action=productdetails&id=<?php echo (int) $MSQS_QL->get_option('mw_wc_qbo_sync_service_id');?>" class="CmnBtn">Connect</a>
						  </div>
					   </div>
					</div> 
