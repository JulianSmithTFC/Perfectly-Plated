...
$total_records = $MSQS_QL->count_woocommerce_product_list($product_map_search,false,$product_type_srch);
...
$wc_product_list = $MSQS_QL->get_woocommerce_product_list($product_map_search," $offset , $items_per_page",false,$product_type_srch);
...
<script type="text/javascript">
	function search_item(){		
		...
		if(product_map_search!='' || product_type_srch!=''){			
			window.location = '<?php echo $page_url;?>&product_map_search='+product_map_search+'&product_type_srch='+product_type_srch;
		}else{
	...
	function reset_item(){		
		window.location = '<?php echo $page_url;?>&product_map_search=&product_type_srch=';
	}
