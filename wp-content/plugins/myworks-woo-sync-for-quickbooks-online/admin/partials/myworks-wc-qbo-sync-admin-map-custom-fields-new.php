...
if ( ! empty( $_POST ) && check_admin_referer( 'myworks_wc_qbo_sync_map_wc_qbo_cf', 'map_wc_qbo_cf' ) ) {
	...
	if(isset($_POST['wq_mcf_wcf']) && is_array($_POST['wq_mcf_wcf']) && isset($_POST['wq_mcf_qcf']) && is_array($_POST['wq_mcf_qcf'])){
		...
		$ext_valid_ft = ['Date'];
		$ext_valid_ev = ['yyyy-mm-dd','dd-mm-yyyy','mm-dd-yyyy','yyyy/mm/dd','dd/mm/yyyy','mm/dd/yyyy'];
								...
								<tbody id="wq_mcf_tb">
									...
									<tr>
										<td>
											...
											<input type="hidden" class="mcf_txt" name="wq_mcf_wcf_tf_ft[]"/>
											<input type="hidden" class="mcf_txt" name="wq_mcf_wcf_tf_ev[]"/>
