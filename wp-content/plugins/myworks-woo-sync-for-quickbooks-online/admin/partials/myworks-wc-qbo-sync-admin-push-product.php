...
$total_records = $MSQS_QL->count_woocommerce_product_list($product_push_search,false,$product_type_srch);
...
$wc_product_list = $MSQS_QL->get_woocommerce_product_list($product_push_search," $offset , $items_per_page",false,$product_type_srch);
...
<?php $sync_window_url = $MSQS_QL->get_sync_window_url();?>
 <script type="text/javascript">
	function search_item(){		
		...
		if(product_push_search!='' || product_type_srch!=''){			
			window.location = '<?php echo $page_url;?>&product_push_search='+product_push_search+'&product_type_srch='+product_type_srch;
		}else{
			alert('<?php echo __('Please enter search keyword or select product type.','mw_wc_qbo_sync')?>');
		}
	}

	function reset_item(){		
		window.location = '<?php echo $page_url;?>&product_push_search=&product_type_srch=';
	}
