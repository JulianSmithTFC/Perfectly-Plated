    ...
    <div class="container-fluid">
        <div class="container menu-blockOne-container">
            <div align="center">
                ...
                <p class="menu-blockOne-instructionsText">Our menu changes weekly, new menus are released each <strong>Monday</strong>. The deadline for ordering is each <strong>Wednesday at 11:59pm</strong>. Meals are then ready for pick-up or delivery on Sunday and Wednesday evenings.</p>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="container menu-blockTwo-container">
            <?php if($available == 1){ ?>
                <div class="row">
                            ...
                            foreach($mainArray['Sun/Mon']  as $catname=>$catpro){
                                if(!empty($catpro)){
                                    foreach($catpro as $pro){
                                        ...
                                        <!-- Card -->
                                        <div class="card" style="max-width: 400px; margin-top: 30px; margin-bottom: 30px">
                                            ...
                                            <a href="<?php echo get_permalink($ProID); ?>">
                                                ...
                                                if(!empty($image)){
                                                    ?>
                                                    <div class="card-img-top" style="background-image: url('<?php  echo $image[0]; ?>'); min-height: 200px; background-size: cover; background-position: center;">

                                                    </div>
                                                    <?php
                                                }else{
                                                    ?>
                                                    <img class="card-img-top" src="<?php echo esc_url( wc_placeholder_img_src( 'woocommerce_single' ) ); ?>" alt="<?php echo $ProName; ?>">
                                                    <?php
                                                }
                                                ?>
                                            </a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <!-- Title -->
                                                <h4 class="card-title"><a href="<?php echo get_permalink($ProID); ?>"><?php echo $ProName; ?></a></h4>
                                                <!-- Text -->
                                                ...
                                                <a href="<?php echo get_permalink($ProID); ?>" class="btn btn-primary">view product</a>
                    ...
                    <div class="col-md-12" style="padding-left:0px;padding-right:0px;" align="center">
                        <h2 class="menu-blockTwo-titles">
                            <?php echo 'Sunday, Monday, & Wednesday'; ?>
                        </h2>
                        <hr class="menu-blockTwo-hrLines"/>
                        <?php
                            foreach($mainArray['Both']  as $catname=>$catpro){
                                if(!empty($catpro)){
                                    foreach($catpro as $pro){
                                        $ProID = $pro->get_id();
                                        $ProName = $pro->get_name();
