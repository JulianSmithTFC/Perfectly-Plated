...
if(!empty($items)){
    foreach($items as $iid=>$item){
        ...
        if($day == 'Monday' || $day == 'Sunday'){
            $arrayForSunMon[$iid] = $item;
        }elseif($day == 'Wednesday'){
            $arrayForWed[$iid] = $item;
        }else{
        ...
        <tr >
            <td>
                <table cellspacing="100">
                    ...
                    <tr>
                        ...
                        <th class="product" style="text-align:center;border:1px solid #DDD;padding:5px;">Meal</th>
                        <th class="product" style="text-align:center;border:1px solid #DDD;padding:5px;">Ready</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    if(!empty($arrayForSunMon)){

                        foreach($arrayForSunMon as $item_id=>$item){
                            ?>
            ...
            <td>
                <table>
                    ...
                    <?php
                    if(!empty($arrayForSunMon)){
                        foreach($arrayForWed as $item_id=>$item){
                            ?>
                            <tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
                                <td class="quantity" style="border:1px solid #DDD;padding:5px;"><?php echo $item['quantity']; ?></td>
                                <td class="product" style="border:1px solid #DDD;padding:5px;">
