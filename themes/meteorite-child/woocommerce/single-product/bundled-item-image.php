...
?><div class="<?php echo esc_attr( implode( ' ', $gallery_classes ) ); ?>"><?php
    ...
    if ( has_post_thumbnail( $product_id ) ) {
        ...
        $html .= sprintf( '<img class="wp-post-image z-depth-3" src="%1$s" alt="%2$s"/>', wc_placeholder_img_src(), __( 'Bundled product placeholder image', 'woocommerce-composite-products' ), $image_rel );
        $html .= '</figure>';
    }
